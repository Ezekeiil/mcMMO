...
public class MiningManager extends SkillManager{
    ...
    public void miningBlockCheck(BlockState blockState) {
        ...
        mcMMO.p.debug("[Award XP] " + getPlayer().getName() + " " + SkillType.MINING + " BLOCK_BREAK " + blockState);
        ...
        for (BlockState blockState : ores) {
            if (Misc.getRandom().nextFloat() < (yield + oreBonus)) {
                if (!mcMMO.getPlaceStore().isTrue(blockState)) {
                    ...
                    mcMMO.p.debug("[Award XP] " + getPlayer().getName() + " " + SkillType.MINING + " BLASTMINING " + blockState);
                }
